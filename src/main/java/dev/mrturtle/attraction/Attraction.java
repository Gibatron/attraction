...
public class Attraction implements ModInitializer {
	...
	Superdupercharged: Strike 5 lodestones with lightning at the same time
	Opposites Attract: Have a netherite block attract an iron block
	Where we're going we don't need roads: Use magnetic blocks to propel yourself to Xm/s while flying with an elytra
	*/
