...
public class RideAttractedCriterion extends AbstractCriterion<RideAttractedCriterion.Conditions> {
	static final Identifier ID = new Identifier("attraction", "ride_attracted");
